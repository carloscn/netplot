...
#include "../../NetworkPlot/filemanager.h"
...
QT_MOC_LITERAL(1, 12, 22), // "file_manager_file_size"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 26), // "file_manager_add_file_name"
QT_MOC_LITERAL(4, 63, 20), // "on_save_data_to_disk"
QT_MOC_LITERAL(5, 84, 7) // "quint8*"

    },
    "FileManager\0file_manager_file_size\0\0"
    "file_manager_add_file_name\0"
    "on_save_data_to_disk\0quint8*"
};
...
static const uint qt_meta_data_FileManager[] = {
 ...
 // slots: parameters
    QMetaType::Void, 0x80000000 | 5, QMetaType::ULongLong,    2,    2,
...
void FileManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->file_manager_file_size((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->file_manager_add_file_name((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->on_save_data_to_disk((*reinterpret_cast< quint8*(*)>(_a[1])),(*reinterpret_cast< quint64(*)>(_a[2]))); break;
        case 3: _t->on_save_data_to_disk((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (FileManager::*_t)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileManager::file_manager_file_size)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileManager::file_manager_add_file_name)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FileManager::file_manager_file_size(double _t1)
{
...
// SIGNAL 1
void FileManager::file_manager_add_file_name(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
