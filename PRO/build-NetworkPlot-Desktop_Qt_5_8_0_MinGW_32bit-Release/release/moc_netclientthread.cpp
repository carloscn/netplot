...
void NetClientThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetClientThread::data_prepared)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetClientThread::data_plot)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetClientThread::net_data_ready)) {
                *result = 2;
                return;
            }
        }
        ...
        {
            typedef void (NetClientThread::*_t)(quint32 * , quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetClientThread::net_data_plot)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetClientThread::net_data_save_to_disk)) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetClientThread::net_add_doc_list)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (NetClientThread::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetClientThread::net_file_size)) {
                *result = 7;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetClientThread::net_lic_check_failed)) {
                *result = 8;
                return;
            }
        }
...
const QMetaObject NetClientThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_NetClientThread.data,
      qt_meta_data_NetClientThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
