...
void da_dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<da_dialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 4: _t->on_timer_over_time(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (da_dialog::*)(QByteArray );
...
QT_INIT_METAOBJECT const QMetaObject da_dialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_da_dialog.data,
    qt_meta_data_da_dialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
